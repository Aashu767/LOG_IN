                            ...
                            children: [
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text:
                                            '${complaintlist[index].complaintNo}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text:
                                            '${complaintlist[index].customerName}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: '${complaintlist[index].address}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: '${complaintlist[index].problem}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text:
                                            '${complaintlist[index].problemSince}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: '${complaintlist[index].nature}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: '${complaintlist[index].eMail}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: '${complaintlist[index].pinCode}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: '${complaintlist[index].mrCode}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: '${complaintlist[index].colony}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: '${complaintlist[index].status}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text:
                                            '${complaintlist[index].aSSIGNTOName}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text:
                                            '${complaintlist[index].registrationDate}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text:
                                            '${complaintlist[index].completionDate}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text:
                                            '${complaintlist[index].buttonDisplay}',
                                        style: const TextStyle(
                                          color: Colors.grey,
                                          fontWeight: FontWeight.bold,
                                        ),
