// ignore_for_file: camel_case_types, unnecessary_new, unnecessary_this, prefer_collection_literals, unnecessary_question_mark

class date_filter {
  List<ComplaintsList>? complaintsList;

  date_filter({this.complaintsList});

  date_filter.fromJson(Map<String, dynamic> json) {
